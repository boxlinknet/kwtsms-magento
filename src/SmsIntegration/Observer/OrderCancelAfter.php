 ...
 *
 * Sends an SMS notification when an order is cancelled.
...
class OrderCancelAfter implements ObserverInterface
{
    ...
    /**
     * Execute observer for order cancellation.
     *
    ...
    public function execute(Observer $observer): void
    {
        try {
            ...
            if (!$this->config->isIntegrationEnabled('order_cancelled')) {
                return;
            }
            ...
            $message = $this->templateProcessor->render('order_cancelled', $variables, $storeLocale);
            ...
            $this->logger->error('kwtSMS: OrderCancelAfter observer failed', [
